...
// ============================================================
const Q = [
  {id:"q1",num:1,title:"การรับประทานอาหาร",en:"Eating",always:true,max:3,
  ...
  {id:"q2",num:2,title:"การเดิน/การเคลื่อนที่",en:"Walking",always:true,max:3,
   opts:[{v:3,l:"เคลื่อนที่นอกบ้านได้เองโดยไม่ต้องช่วยทางกาย"},{v:2,l:"เคลื่อนที่ข้ามห้องได้เองโดยไม่ต้องช่วยทางกาย"},{v:1,l:"ย้ายจากเตียงไปเก้าอี้ได้โดยไม่ต้องช่วย"},{v:0,l:"ต้องช่วยทางกายในการเดินหรือย้ายตัว"}]},
  {id:"q3",num:3,title:"การขับถ่ายที่ห้องน้ำ",en:"Bowel & Bladder",always:true,max:3,
   opts:[{v:3,l:"ทำทุกอย่างที่จำเป็นได้เอง โดยไม่ต้องมีผู้ดูแลหรือช่วย"},{v:2,l:"ต้องมีผู้คอยดูแล/กำกับ แต่ไม่ต้องช่วยทางกาย"},{v:1,l:"ต้องช่วยทางกาย และโดยปกติกลั้นได้"},{v:0,l:"ต้องช่วยทางกาย และโดยปกติกลั้นไม่ได้"}]},
  {id:"q4",num:4,title:"การอาบน้ำ",en:"Bathing",always:true,max:3,
   opts:[{v:3,l:"อาบน้ำได้เองโดยไม่ต้องเตือน/กำกับ และไม่ต้องช่วยทางกาย"},{v:2,l:"ไม่ต้องช่วยทางกาย แต่ต้องมีการกำกับ/เตือนเพื่อให้อาบน้ำได้ครบถ้วน"},{v:1,l:"ต้องช่วยทางกายเล็กน้อย (เช่น ช่วยสระผม) เพื่อให้อาบได้ครบ"},{v:0,l:"ต้องมีผู้อื่นอาบน้ำให้ทั้งหมด"}]},
  {id:"q5",num:5,title:"การดูแลความสะอาด/แต่งตัวส่วนตัว",en:"Grooming",always:true,max:3,
...
const Register = ({onBack,onSuccess})=>{
  ...
  const submit=async()=>{
    ...
    try {
      ...
      if(docs.find(d=>d.license===f.license)) { setErr("เลข ว. นี้มีในระบบแล้ว"); setLoading(false); return; }
      const doc={id:uid(),firstName:f.firstName,lastName:f.lastName,license:f.license,pass:f.pass,role:"doctor",createdAt:new Date().toISOString()};
  ...
  return(
    <div style={{minHeight:"100vh",background:C.bg,display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
      <Card style={{width:"100%",maxWidth:460}}>
        ...
        <Input label="รหัสผ่าน" value={f.pass} onChange={update("pass")} type="password" required/>
